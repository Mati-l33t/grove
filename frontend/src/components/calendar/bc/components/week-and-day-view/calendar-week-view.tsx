...
export function CalendarWeekView({ singleDayEvents, multiDayEvents }: IProps) {
  ...
  const weekStart = startOfWeek(selectedDate, { weekStartsOn: firstDayOfWeek as 0 | 1 })
                          ...
                          >
                            ...
                            <DroppableTimeBlock date={day} hour={hour} minute={0}>
                              <div
                                ...
                                onClick={() => { const d = new Date(day); d.setHours(hour, 0, 0, 0); onDateClick(d) }}
                              />
                            </DroppableTimeBlock>
                            <DroppableTimeBlock date={day} hour={hour} minute={15}>
                              <div
                                ...
                                onClick={() => { const d = new Date(day); d.setHours(hour, 15, 0, 0); onDateClick(d) }}
                              />
                            </DroppableTimeBlock>
                            ...
                            <DroppableTimeBlock date={day} hour={hour} minute={30}>
                              <div
                                ...
                                onClick={() => { const d = new Date(day); d.setHours(hour, 30, 0, 0); onDateClick(d) }}
                              />
                            </DroppableTimeBlock>
                            <DroppableTimeBlock date={day} hour={hour} minute={45}>
                              <div
                                ...
                                onClick={() => { const d = new Date(day); d.setHours(hour, 45, 0, 0); onDateClick(d) }}
                              />
                            </DroppableTimeBlock>
                          </div>
                        )
