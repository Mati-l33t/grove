...
echo -e "${TAB}${GN}🔧 PocketBase: ${BL}http://${CT_IP}:8090/_/${CL}"
echo -e "${TAB}${YW}📋 Logs:       journalctl -u grove -f  (inside container)${CL}"
echo -e "${TAB}${YW}🖥️  Enter:      pct enter ${CTID}${CL}"
echo ""
echo -e "${TAB}Open the app and register your first user account."
echo -e "${TAB}Use the PocketBase URL to manage users and instance settings."
echo ""
